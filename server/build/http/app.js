...
class App {
    ...
    initSwagger() {
                ...
                paths: {
                    ...
                    "/users/me/favorites": {
                        get: {
                            ...
                            description: "Retorna as palavras favoritas do usuário autenticado",
                            tags: ["Usuários"],
                            responses: {
                                200: {
                    ...
                    "/users/me/history": {
                        get: {
                            ...
                            description: "Retorna o histórico de palavras do usuário autenticado",
                            tags: ["Usuários"],
                            responses: {
                                200: {
        ...
        this.app.register(swagger_ui_1.default, {
    ...
    initRoutes() {
        this.app.register(routes_1.default);
    ...
    initHandleErrors() {
        this.app.setErrorHandler(handleErrors_1.default);
    }
}
exports.default = App;
